...
class Bank(ABC):
    ...
    [IMPLEMENT ME]
        v 1. This class must derive from class ABC
        v 2. Write a basicinfo() function that prints out "This is a generic bank" and
           returns the string "Generic bank: 0"
        v 3. Define a second function called withdraw and keep it empty by
...
class Swiss(Bank):
    ...
    [IMPLEMENT ME]
        v 1. This class must derive from class Bank
        v 2. Create a constructor for this class that initializes a class
           variable `bal` to 1000
        v 3. Implement the basicinfo() function so that it prints "This is the
        ...
        v 4. Implement withdraw so that it takes one argument (in addition to
